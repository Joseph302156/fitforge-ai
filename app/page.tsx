...
const HomeTab = dynamic(() => import("./components/HomeTab").then(mod => ({ default: mod.default })), { ssr: false });
...
const TABS = [
  {
    id: "home", label: "Home",
    icon: (active: boolean) => (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={active?"#4f46e5":"#9ca3af"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
